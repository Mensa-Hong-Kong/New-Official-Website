    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Spatie\Permission\Contracts\Permission' => \App\Models\ModulePermission::class,
            'Spatie\Permission\Contracts\Role' => \App\Models\TeamRole::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/tszyuloveyou/Projects/New-Official-Website/public/storage' => 'string',
            ...
            'services.twilio.whatsapp.from' => 'string',
            'services.twilio.whatsapp.templateIDs.verificationCode' => 'string',
            'services.twilio.whatsapp.templateIDs.newPassword' => 'string',
            ...
            'stripe.keys.public' => 'string',
            'stripe.keys.secret' => 'string',
            'stripe.keys.webhook' => 'string',
            'stripe.lifetime.transaction' => 'string',
            'stripe.lifetime.webhook' => 'string',
            'stripe.currency' => 'string',
            'stripe.minimum_amount' => 'integer',
            'stripe.paymentMethodTypes.payment' => 'array',
            'stripe.paymentMethodTypes.subscription' => 'array',
...
'app.aliases.View','app.aliases.Vite','app.extendAdmissionTestQuotaExpiredDate.whenAfterThan','app.extendAdmissionTestQuotaExpiredDate.to','auth.defaults.guard',
...
'auth.passwords.users.throttle','auth.password_timeout','boost.enabled','boost.browser_logs_watcher','boost.executable_paths.php',
'boost.executable_paths.composer','boost.executable_paths.npm','boost.executable_paths.vendor_bin','broadcasting.default','broadcasting.connections.reverb.driver',
...
'cache.prefix','columnsortable.columns','columnsortable.enable_icons','columnsortable.default_icon_set','columnsortable.sortable_icon',
...
'columnsortable.join_type','database.default','database.connections.sqlite.driver','database.connections.sqlite.url','database.connections.sqlite.database',
...
'database.connections.sqlite.synchronous','database.connections.sqlite.transaction_mode','database.connections.sqlite.pragmas','database.connections.mysql.driver','database.connections.mysql.host',
...
'database.connections.mysql.collation','database.connections.mariadb.driver','database.connections.mariadb.url','database.connections.mariadb.host','database.connections.mariadb.port',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/tszyuloveyou/Projects/New-Official-Website/public/storage',
...
'reverb.apps.apps.0.rate_limiting.terminate_on_limit','services.postmark.token','services.resend.key','services.ses.key','services.ses.secret',
'services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.twilio.sid','services.twilio.token',
'services.twilio.whatsapp.from','services.twilio.whatsapp.templateIDs.verificationCode','services.twilio.whatsapp.templateIDs.newPassword','session.driver','session.lifetime',
...
'session.secure','session.http_only','session.same_site','session.partitioned','stripe.keys.public',
'stripe.keys.secret','stripe.keys.webhook','stripe.lifetime.transaction','stripe.lifetime.webhook','stripe.currency',
'stripe.minimum_amount','stripe.paymentMethodTypes.payment','stripe.paymentMethodTypes.subscription','mcp.redirect_domains','sanctum.stateful',
...
'contacts.send-verify-code','contacts.verify','contacts.set-default','contacts.store','contacts.update',
'contacts.destroy','admission-tests.candidates.show','admission-tests.candidates.create','admission-tests.candidates.store','admission-tests.candidates.destroy',
'admission-test.orders.leaving-payment','admin.index','admin.team-types.display-order.update','admin.team-types.index','admin.team-types.update',
'admin.teams.display-order.update','admin.teams.index','admin.teams.create','admin.teams.store','admin.teams.show',
'admin.teams.edit','admin.teams.update','admin.teams.destroy','admin.teams.roles.display-order.update','admin.teams.roles.create',
'admin.teams.roles.store','admin.teams.roles.edit','admin.teams.roles.update','admin.teams.roles.destroy','admin.modules.display-order.update',
'admin.modules.index','admin.modules.update','admin.permissions.display-order.update','admin.permissions.index','admin.permissions.update',
'admin.users.index','admin.users.show','admin.users.update','admin.users.reset-password','admin.contacts.store',
'admin.contacts.update','admin.contacts.destroy','admin.contacts.verify','admin.contacts.default','admin.admission-test.products.index',
'admin.admission-test.products.create','admin.admission-test.products.store','admin.admission-test.products.show','admin.admission-test.products.update','admin.admission-test.products.prices.store',
'admin.admission-test.products.prices.update','admin.admission-test.types.index','admin.admission-test.types.create','admin.admission-test.types.store','admin.admission-test.types.edit',
...
'admin.admission-test.orders.show','admin.admission-test.orders.status.update','admin.admission-test.orders.admission-tests.store','admin.admission-test.orders.admission-tests.destroy','admin.admission-tests.index',
'admin.admission-tests.create','admin.admission-tests.store','admin.admission-tests.show','admin.admission-tests.update','admin.admission-tests.destroy',
'admin.admission-tests.proctors.store','admin.admission-tests.proctors.update','admin.admission-tests.proctors.destroy','admin.admission-tests.candidates.seat-numbers.update','admin.admission-tests.candidates.status.update',
'admin.admission-tests.candidates.result.update','admin.admission-tests.candidates.store','admin.admission-tests.candidates.show','admin.admission-tests.candidates.edit','admin.admission-tests.candidates.update',
'admin.admission-tests.candidates.destroy','admin.site-contents.index','admin.site-contents.edit','admin.site-contents.update','admin.custom-web-pages.index',
'admin.custom-web-pages.create','admin.custom-web-pages.store','admin.custom-web-pages.edit','admin.custom-web-pages.update','admin.custom-web-pages.destroy',
'admin.navigation-items.index','admin.navigation-items.create','admin.navigation-items.store','admin.navigation-items.edit','admin.navigation-items.update',
'admin.navigation-items.destroy','admin.navigation-items.display-order.update','admin.other-payment-gateways.index','admin.other-payment-gateways.update','admin.other-payment-gateways.active.update',
'admin.other-payment-gateways.display-order.update','custom-web-page','webhooks.stripe','storage.local',
