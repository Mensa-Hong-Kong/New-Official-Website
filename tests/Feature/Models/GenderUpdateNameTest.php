...
class GenderUpdateNameTest extends TestCase
{
    ...
    public function test_name_have_no_change(): void
    {
        $gender = Gender::inRandomOrder()->first();
        $id = $gender->id;
        User::factory()->create(['gender_id' => $id]);
        $name = $gender->name;
    ...
    public function test_name_change_and_only_has_one_user_using_and_have_no_other_row_has_same_name(): void
    {
        $gender = Gender::inRandomOrder()->first();
        $id = $gender->id;
        User::factory()->create(['gender_id' => $id]);
    ...
    public function test_name_change_and_only_has_one_user_using_and_has_other_row_has_same_name(): void
    {
        $gender = Gender::inRandomOrder()->first();
        $id = $gender->id;
        User::factory()->create(['gender_id' => $id]);
    ...
    public function test_name_change_and_has_more_than_one_user_using_and_have_no_other_row_has_same_name(): void
    {
        $gender = Gender::inRandomOrder()->first();
        $id = $gender->id;
        User::factory()->create(['gender_id' => $id]);
    ...
    public function test_name_change_and_has_more_than_one_user_using_and_has_other_row_has_same_name(): void
    {
        $gender = Gender::inRandomOrder()->first();
        $id = $gender->id;
        User::factory()->create(['gender_id' => $id]);
