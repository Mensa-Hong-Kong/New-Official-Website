...
{
    public function test_get_actual_decimal_when_currency_is_special_decimal(): void
    {
    ...
    public function test_get_actual_decimal_when_currency_is_normal_currency(): void
    {
    ...
    public function test_get_validation_decimal_when_currency_is_special_actual_decimal(): void
    {
    ...
    public function test_get_validation_decimal_when_currency_is_special_decimal_but_not_special_actual_decimal(): void
    {
    ...
    public function test_get_validation_decimal_when_currency_is_normal_currency(): void
    {
    ...
    public function test_get_maximum_digits_when_currency_is_special_maximum_digits(): void
    {
    ...
    public function test_get_maximum_digits_when_currency_is_normal_currency(): void
    {
    ...
    public function test_get_maximum_validation_when_currency_is_special_maximum_digits_currency(): void
    {
        config(['stripe.currency' => 'idr']);
        $this->assertEquals(9999999.99, Amount::getMaximumValidation());
    }

    public function test_get_maximum_validation_when_currency_is_normal_digits_and_special_actual_decimal(): void
    {
        config(['stripe.currency' => 'twd']);
        $this->assertEquals(999999, Amount::getMaximumValidation());
    }

    public function test_get_maximum_validation_when_currency_is_normal_digits_and_special_decimal(): void
    {
        config(['stripe.currency' => 'xpf']);
        $this->assertEquals(99999999, Amount::getMaximumValidation());
    }

    public function test_get_maximum_validation_when_currency_is_normal_currency(): void
    {
